...
class ApartmentDetailes extends StatefulWidget {
  final Apartment apartment;

  ApartmentDetailes({required this.apartment});

  @override
  State<ApartmentDetailes> createState() => _ApartmentDetailesState();
}

class _ApartmentDetailesState extends State<ApartmentDetailes> {
  ...
  void _toggleFavorite(){
    ...
    } else if (FirebaseAuth.instance.currentUser!.uid == '${widget.apartment.properties.User_id}') {
      Fluttertoast.showToast(
        ...
        .doc(cpuid)
        .collection('Favorite')
        .doc(widget.apartment.properties.property_id)
        .delete();
      }else{
        _fav = true ;
  ...
  Widget build(BuildContext context) {
    ...
    String classification = widget.apartment.properties.classification;
    ...
    return SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            Hero(
              tag: '${widget.apartment.properties.images.length}' == '0'
                  ? 'https://www.guardanthealthamea.com/wp-content/uploads/2019/09/no-image.jpg'
                  : widget.apartment.properties.images[0], //'${apartment.images[0]}'
              child: Container(
                height: size.height * 0.5,
                decoration: '${widget.apartment.properties.images.length}' == '0'
                    ? BoxDecoration(
                    ...
                    : BoxDecoration(
                        image: DecorationImage(
                          image: NetworkImage(
                              '${widget.apartment.properties.images[0]}'), //'${villa.images[0]}'
                          fit: BoxFit.cover,
                        ),
                      ),
                child: Container(
                ...
                children: [
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    if (FirebaseAuth.instance.currentUser == null) {
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => Complaints(property_id: widget.apartment.properties.property_id, user_id: widget.apartment.properties.User_id,)),
                                      );
                                    }
                                  },
                                ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          '${widget.apartment.properties.type} ${Classification}',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 14,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '${widget.apartment.properties.type}',
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 32,
                            fontWeight: FontWeight.bold,
                        ...
                        Text(
                          'ريال ${widget.apartment.properties.price}',
                          style: TextStyle(
                            height: 2,
                            color: Colors.white,
                            fontSize: 24,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              '${widget.apartment.properties.neighborhood} ، ${widget.apartment.properties.city}',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              '${widget.apartment.number_of_room}',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                            ...
                            Text(
                              '${widget.apartment.number_of_bathroom}',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                            ...
                            Text(
                              '${widget.apartment.properties.space} متر ² ',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                                ...
                                children: [
                                  FutureBuilder<DocumentSnapshot>(
                                    future: FirebaseFirestore.instance
                                        .collection('Standard_user')
                                        .doc('${widget.apartment.properties.User_id}')
                                        .get(),
                          ...
                          child: Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    '${widget.apartment.property_age} سنة',
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    '${widget.apartment.number_of_floor}',
                                    textDirection: TextDirection.rtl,
                                    style: TextStyle(
                                      fontSize: 16,
                                      color: Colors.grey[500],
                        ...
                        '${widget.apartment.properties.description}' == ''
                            ? Container()
                            : Column(
                                crossAxisAlignment: CrossAxisAlignment.end,
                                children: [
                        ...
                        '${widget.apartment.properties.images.length}' == '0'
                            ? Container(
                                height: 50,
                                alignment: Alignment.center,
                                child: Padding(
                            ...
                            : Container(
                                ...
                                child: Padding(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemCount: widget.apartment.properties.images.length,
                                    itemBuilder: (context, index) => InkWell(
                                      onTap: () =>
                                          openGallery(widget.apartment.properties.images, context),
                                      borderRadius: BorderRadius.circular(15),
                                      child: Image.network(
                                        widget.apartment.properties.images[index],
                                      ),
                                    ),
                                  ),
                                ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsets.only(right: 25, left: 5, bottom: 16),
                              child: Text(
                                '${widget.apartment.properties.Location}',
                                textAlign: TextAlign.right,
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.grey[500],
